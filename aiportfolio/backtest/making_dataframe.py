...
try:
    ...
    for record in data:
        ...
        #    - 가중치에서 '%'를 제거하고 100으로 나눠 소수점 형태의 숫자로 변환합니다.
        #    - 예: "39.4605%" -> 0.394605
        ...
        # 5. 완성된 딕셔너리를 리스트에 추가합니다.
        processed_data.append(portfolio_dict)

    # --- 데이터 가공 끝 ---

    # 6. 가공된 데이터를 바탕으로 최종 DataFrame을 생성합니다.
    df_result = pd.DataFrame(processed_data)
    
    # 7. (선택사항) 'forecast_date' 컬럼을 맨 앞으로 오도록 순서를 조정합니다.
